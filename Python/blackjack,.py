...
def higher_card(card_one, card_two):
    ...
    # Check if we can afford an 11 without going bust
    if hand_value + 11 <= 21:
        return 11
...
def is_blackjack(card_one, card_two):
    ...
    # Check if one is Ace and the other is in the tens tuple
    one_is_ace_two_is_ten = (card_one == 'A' and card_two in tens)
    two_is_ace_one_is_ten = (card_two == 'A' and card_one in tens)
    
    return one_is_ace_two_is_ten or two_is_ace_one_is_ten
